...
\textbf{Main Success Scenario:}
\begin{enumerate}
    \item Tech Support/IT logs into the VANKL secure chat application.
    \item The system authenticates Tech Support/IT.
    \item Once authenticated, Tech Support/IT provides any needed assistance for technical issues related to secure communication.
    \item The system also allows Tech Support/IT to monitor and troubleshoot the secure communication platform.
\end{enumerate}
\textbf{Secondary Scenarios:}
\begin{enumerate}
    \item[\textbf{2i.}] The system fails to authenticate Tech Support/IT.
    \begin{enumerate}
        \item[\textbf{2i.1}] The system will prompt Tech Support/IT to retry for authentication.
        \item[\textbf{2i.2}] If the issue persists, then Tech Support/IT will be redirected to contact the KDC administrator.
    \end{enumerate}
    \item[\textbf{3i.}] Tech Support/IT faces challenges during debugging and troubleshooting, due to an unexpected server outage.
    \begin{enumerate}
        \item[\textbf{3i.1}] The system provides a display message to inform Tech Support/IT of this outage and apologizes for the inconvenience.
        \item[\textbf{3i.2}] The system will advise Tech Support/IT to try again at another time when the server comes back online.
    \end{enumerate}
\end{enumerate}
...
\textbf{Main Success Scenario:}
\begin{enumerate}
    \item The Security Auditors/Cybersecurity logs into the VANKL secure chat application.
    \item The system authenticates the Security Auditors/Cybersecurity.
    \item Once authenticated, the Security Auditors/Cybersecurity can audit the system for potential security vulnerabilities and assess the system’s compliance with data regulations.
\end{enumerate}
\textbf{Secondary Scenarios:}
\begin{enumerate}
    \item[\textbf{2i.}] The system fails to authenticate the Security Auditors/Cybersecurity.
    \begin{enumerate}
        \item[\textbf{2i.1}] The system will prompt the Security Auditors/Cybersecurity to retry for authentication.
        \item[\textbf{2i.2}] If the issue persists, then the Security Auditors/Cybersecurity will need to collaborate their efforts alongside tech support.
        \item[\textbf{2i.3}] If necessary, the Security Auditors/Cybersecurity may investigate this issue further and deem it to be a potential security concern.
    \end{enumerate}
    ...
    \begin{enumerate}
        \item[\textbf{3i.1}] The system provides a display message to inform the Security Auditors/Cybersecurity of the system issue, and apologizes for the inconvenience.
        \item[\textbf{3i.2}] The system will prompt the Security Auditors/Cybersecurity to retry the action.
        \item[\textbf{3i.3}] If necessary, the Security Auditors/Cybersecurity may investigate this issue further and deem it to be a potential security concern.
    \end{enumerate}
\end{enumerate}
...
\textbf{Main Success Scenario:}
\begin{enumerate}
    \item The Board of Directors logs into the VANKL secure chat application.
    \item The system authenticates the Board of Directors.
    \item Once authenticated, the Board of Directors can access the broadcasting channel feature.
    \item The system shall allow the Board of Directors to send one-way messages (e.g. an announcement) to all employees of the company.
\end{enumerate}
\textbf{Secondary Scenarios:}
\begin{enumerate}
    \item[\textbf{2i.}] The system fails to authenticate the Board of Directors.
    \begin{enumerate}
        \item[\textbf{2i.1}] The system will prompt the Board of Directors to retry for authentication.
        \item[\textbf{2i.2}] If the issue persists, then the Board of Directors will need to contact tech support.
    \end{enumerate}
    ...
    \begin{enumerate}
        \item[\textbf{3i.1}] The system provides a display message to inform the Board of Directors of this delay, and apologizes for the inconvenience.
        \item[\textbf{3i.2}] The system will continuously attempt to alleviate the increased demand, by utilizing backup servers, caching, and load balancing.
    \end{enumerate}
\end{enumerate}
...
\textbf{Main Success Scenario:}
\begin{enumerate}
    \item A Board of Directors member logs into the VANKL secure chat application.
    \item The system authenticates each Board of Directors member successfully.
    \item Once authenticated, each Board of Directors member can access the one-way broadcasting channel feature.
    \item The system allows each Board of Directors member to send one-way messages to all employees in the broadcasting channel.
\end{enumerate}
\textbf{Secondary Scenarios:}
\begin{enumerate}
    \item[\textbf{2i.}] The system fails to authenticate a Board of Directors member.
    \begin{enumerate}
        \item[\textbf{2i.1}] The system will prompt the member to retry for authentication.
        \item[\textbf{2i.2}] If the issue persists, then the member will be redirected to contact tech support.
    \end{enumerate}
    ...
    \begin{enumerate}
        \item[\textbf{3i.1}] The system provides a display message to inform the member of this delay, and apologizes for the inconvenience.
        \item[\textbf{3i.2}] The system will continuously attempt to alleviate the increased demand, by utilizing backup servers, caching, and load balancing.
    \end{enumerate}
    ...
    \begin{enumerate}
        \item[\textbf{4i.1}] The system provides a display message to inform the member of this issue, and apologizes for the inconvenience.
        \item[\textbf{4i.2}] The system advises the member to report this issue to Tech Support/IT.
    \end{enumerate}
\end{enumerate}
\textbf{Global Scenario:}
\subsubsection*{Precondition:} The secure chat application has already been installed on an Android device, the user has an account, and all necessary configurations have been made.\newline\newline
